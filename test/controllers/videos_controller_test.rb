...
class VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video" do
    assert_difference("Video.count") do
      post videos_url, params: { video: { filename: @video.filename, user_id: @video.user_id } }
    end
  ...
  test "should update video" do
    patch video_url(@video), params: { video: { filename: @video.filename, user_id: @video.user_id } }
